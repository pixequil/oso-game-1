...
label .rt:
    ...
    if saw.redtile == False:
        ...
        redtile "You could think of it as an improvement, like those art restorers who repaint old pictures back to new."
...
label .painting:
    if saw.bluetile == False:
        ...
        bluetile "This artwork in particular really speaks to me! It's a portrait of Crayon Box, the host of that Open Source Objects show in the dome! Does it speak to you to?"
