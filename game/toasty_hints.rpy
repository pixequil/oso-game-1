...
label toasty_hints:
    ...
    # below this line are hints displayed in roughly reverse walkthrough order
        ...
        p concerned "Toasty don't: that was a painting someone kindly given me!"
        ...
        p "Some poor starving artist who hadn't eaten a crumb for months: looked absolutely disheveled."
        ...
        hide badpainting
        p "You feeling sorry for someone? That is development I thought I never see!"
        ...
        t "I guess I need to organize a strategy meeting ASAP."
        ...
        t "If I had an approximation of art, I would go head first towards the snootiest person in the area!"
        ...
        t "Before we can say 'easel', we will be super rich beyond our damn dreams!!"
        ...
        t neutral "I would looove to eat another waffle with triple syrup, but I have no napkin."
        t "Can I borrow yours-"
        p neutral -quiet "No."
        t angry "GOD DAMNIT THIS PLAN WAS SUPPOSED TO BE FOOLPROOF!"
        return
